...
import group10.partyfinder.PartyItemFragment.OnListFragmentInteractionListener;
...
public class MyPartyItemRecyclerViewAdapter extends RecyclerView.Adapter<MyPartyItemRecyclerViewAdapter.ViewHolder> {
    ...
    public MyPartyItemRecyclerViewAdapter(List<DummyItem> items, OnListFragmentInteractionListener listener) {
        mValues = items;
        mListener = listener;
    }
